...
Assuming that $\langle x - z, w - z \rangle$ is purely real as we live in a real Hilbert space, then as we vary $t$, since the inner products are constants, this must hold for all $t \in (0,1]$, and hence, we have that:
